...
class Ui_QSpectrumAnalyzerMainWindow(object):
    def setupUi(self, QSpectrumAnalyzerMainWindow):
        ...
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.buttonsLayout)
        ...
        self.intervalSpinBox.setDecimals(3.0)
    ...
    def retranslateUi(self, QSpectrumAnalyzerMainWindow):
        ...
        self.freqSmoothCheckBox.setText(_translate("QSpectrumAnalyzerMainWindow", "Frequency Smoothing"))
